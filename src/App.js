...
class App extends Component {
  ...
  handleScroll(e) {
    if (e.deltaY < 0) { // scroll up (prev)
      ...
      } else if (this.state.page == 4 && this.scrollPrev2 == 0) {
        this.scrollPrev2 = 1;
     ...
     if (this.state.page == 1 && this.scrollNext2 == 0) {
       ...
       this.scrollNext2 = 1;
       this.setState({ page: this.state.page - 1, currentPage: this.state.currentPage - 1, displayPortfolio: 'block' });
       this.refs.menu.updateMenu(true);
  ...
  render() {
    return (
      <div className="App">
          ...
          <About className="about" height={ window.innerHeight } width={ window.innerWidth } display={this.state.displayAbout} ref="about" />
